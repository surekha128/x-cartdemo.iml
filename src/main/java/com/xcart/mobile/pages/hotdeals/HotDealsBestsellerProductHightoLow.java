 ...
 */
public class HotDealsBestsellerProductHightoLow extends Utility {
    ...
    By selectpricehightolow = By.partialLinkText("Price High - L");
    By verifyproductarrangehightolow = By.xpath("//body/div[@id='mm-0']/div[@id='page-wrapper']/div[@id='page']/div[@id='main-wrapper']/div[@id='main']/div[1]/div[3]/div[1]/div[1]/div[2]/div[1]");
    ...
    public void hoveronsortbyandclickpricehightolow(){
        Reporter.log("Clicking on login link " + hoversortby.toString() + "<br>");
        Reporter.log("Clicking on login link " + selectpricehightolow.toString() + "<br>");

        mouseHoverToElement(hoversortby);
        clickOnElement(selectpricehightolow);
        List<WebElement> deskTopList = driver.findElements(verifyproductarrangehightolow);
